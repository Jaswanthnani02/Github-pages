...
const PROJECT_DETAILS = {
    dispatcher: {
        ...
        body: `
            ...
            <h4>What I built</h4>
            <ul>
                <li>Azure Functions on the PSA/ticketing REST API (ConnectWise Manage)</li>
                <li>Board selection by condition; round-robin and weighted-load assignment</li>
                <li>Companion metrics view for processed tickets, time saved, and fairness</li>
            </ul>
            <h4>Outcome</h4>
            <ul>
                <li>100,000+ tickets auto-assigned in six months</li>
                <li>History in Azure Blob Storage for ops reporting</li>
            </ul>
            <p><a href="https://github.com/Jaswanthnani02/ticket-dispatcher-demo" target="_blank" rel="noopener noreferrer">Public mock of the assignment core →</a></p>
        `,
        tech: ['Azure Functions', 'PSA REST API', 'Python', 'Azure Blob Storage']
    },
    'ops-dashboard': {
        overline: 'BetterWorld Technology · Production',
        ...
        body: `
            <h4>Problem</h4>
            <p>Leadership needed one place for ticket volume, open work, technician load, account health, and why tickets stall.</p>
            <h4>What I built</h4>
            <ul>
                <li>Ops dashboard on Cosmos DB; Azure Containers + Redis snapshot caching</li>
                <li>PSA API (ConnectWise) + Microsoft 365 integrations</li>
                <li>Time-bounded views, health scores, MTTR, Sankey/bar charts</li>
                <li>Azure AI Foundry reads ticket notes to explain unresolved work</li>
            </ul>
            <h4>Outcome</h4>
    ...
    mcp: {
        ...
        body: `
            <h4>Problem</h4>
            <p>The team needed safe, role-aware tools so LLMs could work against PSA and related products without ad-hoc scripts.</p>
            <h4>What I built</h4>
            <ul>
                <li>MCP tools from product API docs with clear schemas, auth, and RBAC</li>
                <li>Deployed on Azure Containers with auto-scaling</li>
                <li>Coverage across ticketing, RMM, quoting, and CSAT (ConnectWise Manage, Asio, CPQ, SmileBack)</li>
            </ul>
            <p><a href="https://github.com/Jaswanthnani02/mcp-rbac-demo" target="_blank" rel="noopener noreferrer">Public auth + RBAC demo →</a></p>
        `,
        tech: ['MCP', 'Azure Containers', 'RBAC', 'Cosmos DB']
    },
    onboarding: {
        overline: 'BetterWorld Technology · Production',
        ...
        body: `
            <h4>Problem</h4>
            <p>Manual onboarding took 2–5 business days: tickets, briefings, credentials, and group membership.</p>
            <h4>What I built</h4>
            <ul>
                <li>End-to-end n8n flow with approval gates</li>
                <li>Licenses, Microsoft Graph credentials, enterprise apps, managers, calendar, welcome email</li>
            </ul>
            <h4>Outcome</h4>
            <p>New-hire credentials ready in 5–10 minutes instead of days.</p>
        `,
        tech: ['n8n', 'Microsoft Graph', 'PSA platform']
    },
    smartops: {
        overline: 'BetterWorld Technology · Production',
        title: 'SmartOps Ticket AI',
        body: `
            <h4>What I built</h4>
            <ul>
                <li>Python service for AI-assisted ticket categorization and prioritization</li>
                <li>Power Automate hooks for downstream automation</li>
            </ul>
        `,
        tech: ['Python', 'OpenAI', 'Power Automate']
    },
    recon: {
        overline: 'Nexturn · Client engagement',
        title: 'Payment recon pipeline',
        body: `
            <ul>
                <li>Pulled Splunk Data Lake data into production and transformed it with PySpark</li>
                <li>Maintained PostgreSQL for payment reconciliation</li>
    ...
    etl: {
        overline: 'Nexturn · Client engagement',
        title: 'Documented ETL pipelines',
        body: `
            <ul>
                <li>Matillion ETL pipelines integrating Python and SQL</li>
                <li>Automated large-scale transforms; documented flows and dependencies</li>
            </ul>
        `,
